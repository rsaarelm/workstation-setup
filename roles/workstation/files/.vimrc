...
autocmd FileType votl setlocal wrap linebreak showbreak=\ \  colorcolumn=0 foldlevel=0 textwidth=100 tabstop=2 shiftwidth=2 nolist

" todo.txt file niceties
autocmd FileType todo setlocal wrap linebreak colorcolumn=0 showbreak=\ \  formatoptions-=t
